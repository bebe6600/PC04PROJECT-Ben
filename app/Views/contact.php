 <!-- Page Header-->
 <header class="masthead" style="background-image: url('assets/assets/img/carosell_3.jpg')">
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="my-5">
                            ...
                            <!-- to get an API token!-->
                            <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="POST" action="contact_submit">
