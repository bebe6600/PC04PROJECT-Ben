        ...
        <table class="table table-striped table-sm ">
          ...
          <tbody>
            ...
            foreach($productList as $v){
             echo ' <tr>
             <td>'.$v['product_id'].'</td>
             <td><img class="img-fluid" src="'.$v['image_url'].'"/></td>
             <td>'.$v['title'].'</td>
             <td>'.$v['price'].'</td>
             <td>'.$v['short_desc'].'</td>
             <td>'.$v['Taste'].'</td>
             ...
             <td><a class="btn btn-danger mb-1" href="'.base_url('product_edit/'.$v['product_id']).'">edit</a>
             <a class="btn btn-danger" href="'.base_url('product_del/'.$v['product_id']).'">Del</a></td>
