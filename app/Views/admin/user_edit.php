      ...
      <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <button type="button" class="btn btn-sm btn-outline-secondary dropdown-toggle d-flex align-items-center gap-1">
            ...
            <div><a class="btn btn-primary" href="<?= base_url('product_add') ?>">Add User</a></div>
          </div>
          ...
          <main>
            <div class="container-fluid px-4">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method="POST" action="<?= base_url('user_update') ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input id="firstname" name="firstname" class="form-control" value="<?=isset($userdata['firstname'])?$userdata['firstname']:''?>"/>
                    </div>
                   

                    <div class="form-group">
                      <label for="lastname">Lastname</label>
                      <input id="lastname" name="lastname" class="form-control" value="<?=isset($userdata['lastname'])?$userdata['lastname']:''?>"/>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input id="pass" name="pass" class="form-control" value="<?=isset($userdata['pass'])?$userdata['pass']:''?>"/>
                    </div>

                    <div class="form-group">
                      <label for="phone">phone</label>
                      <input id="phone" name="phone" class="form-control" value="<?=isset($userdata['phone'])?$userdata['phone']:''?>"/>
                    </div>
