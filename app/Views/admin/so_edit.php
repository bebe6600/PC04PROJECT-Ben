              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method="POST" action="<?= base_url('so_update') ?>" enctype="multipart/form-data">
                    ...
                    <input type="hidden"  name="so_id" class="form-control" value="<?=$so_id?>" />
                    ...
                    <div>
                      ...
                      <textarea name="remarks" id="remarks" class="form-control"><?= isset($sodata['remarks']) ? $sodata['remarks'] : '' ?></textarea>
                    </div>
