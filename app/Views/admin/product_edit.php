          ...
          <main>
            <div class="container-fluid px-4">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method="POST" action="<?= base_url('product_update') ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input id="ori_price" name="price" class="form-control" value="<?= isset($productData['price']) ? $productData['price'] : '' ?>" />
                    </div>


                    <div class="form-group">
                      <label for="short_desc">Short Description</label>
                      <textarea class="form-control" name="short_desc"><?= isset($productData['short_desc']) ? $productData['short_desc'] : '' ?></textarea>
                    </div>

                    <div class="form-group">
                      <label for="short_desc">Taste</label>
                      <textarea class="form-control" name="Taste"><?= isset($productData['Taste']) ? $productData['Taste'] : '' ?></textarea>
                    </div>

                    <div class="form-group">
                      <label for="short_desc">Ingredients</label>
                      <textarea class="form-control" name="Ingredients"><?= isset($productData['Ingredients']) ? $productData['Ingredients'] : '' ?></textarea>
                    </div>

                    <div class="form-group">
                      <label for="ori_price">Weight</label>
                      <input id="ori_price" name="Weight" class="form-control" value="<?= isset($productData['Weight']) ? $productData['Weight'] : '' ?>" />
                    </div>

                    <div class="form-group">
                      <label for="ori_price">sku</label>
                      <input id="ori_price" name="sku" class="form-control" value="<?= isset($productData['sku']) ? $productData['sku'] : '' ?>" />
                    </div>

                    <div class="form-group">
                      <label for="ori_price">manufacturer</label>
                      <input id="ori_price" name="manufacturer" class="form-control" value="<?= isset($productData['manufacturer']) ? $productData['manufacturer'] : '' ?>" />
                    </div>

                    <div class="form-group">
                      <label for="image_url">Image URL</label>
                      <input type="file" id="image_url" name="image_url" class="form-control" value="<?= isset($productData['image_url']) ? $productData['image_url'] : '' ?>" />
                    </div>
