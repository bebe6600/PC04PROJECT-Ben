            ...
            <table class="table table-bordeded">
              <thead>
                <tr>
                  ...
                  <th>Amount</th>
                  <th>User id</th>
                  <th>shipping_firstname</th>
                  <th>shipping_lastname</th>
             ...
             <td>' . $v['user_id'] . '</td>
             <td>' . $v['shipping_firstname'] . '</td>
             <td>' . $v['shipping_lastname'] . '</td>
             <td>' . $v['shipping_phone'] . '</td>
             <td>' . $v['shipping_email'] . '</td>
             <td>' . $v['shipping_add1'] . '</td>
             <td>' . $v['shipping_add2'] . '</td>
             <td>' . $v['shipping_country'] . '</td>
             <td>' . $v['shipping_city'] . '</td>
